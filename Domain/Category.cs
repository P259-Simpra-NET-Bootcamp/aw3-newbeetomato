...
public class CategoryConfiguration : IEntityTypeConfiguration<Category>
{
    public void Configure(EntityTypeBuilder<Category> builder)
    {
        ...
        builder.HasMany(c => c.Products) // Her bir Category'nin birden çok Product'a sahip olmasını sağlar.
                  .WithOne(p => p.Category) // Her bir Product'ın yalnızca bir Category'ye ait olmasını sağlar.
